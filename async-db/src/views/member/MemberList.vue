...
const memberList = computed((): Map<number, Member> => membersStore.memberList);
const isEmptyList = computed((): boolean => membersStore.isMemberListEmpty);

const isLoading = computed((): boolean => membersStore.isLoading);
</script>
